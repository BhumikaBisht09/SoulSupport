...
const fileUploadWrapper = document.querySelector(".file-uploaded-wrapper");
const filePreviewImg = fileUploadWrapper.querySelector("img");
...
const API_KEY = "AIzaSyDECu7Aot0zVn33_tAbyGpv2hyDrhXLhkE"; 
...
const handleOutgoingMessage = (e) => {
  ...
  const fileImg = userData.file.data
    ? `<img src="data:${userData.file.mime_type};base64,${userData.file.data}" class="attachment" />`
    : "";

  const messageContent = `<div class="message-text"></div>${fileImg}`;
  ...
  setTimeout(() => {
    ...
    const incomingMessageDiv = createMessageElement(botTyping, "bot-message", "thinking");
